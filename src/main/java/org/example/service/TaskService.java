...
public class TaskService {
    ...
    public Task add(String title, String description, LocalDate dueDate){
        ...
        return entityToObjcet(saved);
    }

    public List<Task> getAll() {
        return this.taskRepository.findAll().stream()
                .map(this::entityToObjcet)
    ...
    public Task update(Long id, String title, String description, LocalDate dueDate){
        ...
        return this.entityToObjcet(updated);
    }
    ...
    private Task entityToObjcet(TaskEntity e){
        return Task.builder()
                .id(e.getId())
                .title(e.getTitle())
